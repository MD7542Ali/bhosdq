...
int main(int argc, char *argv[]) {
    // Display the banner
    std::cout << "╔════════════════════════════════════════╗\n";
    std::cout << "║             @PYSCHOxKINGYT PROGRAM              ║\n";
    ...
    if (is_expired()) {
        ...
        std::cout << "║    Telegram: @PYSCHOxKINGYT               ║\n";
        std::cout << "╚════════════════════════════════════════╝\n";
        return 1;
    }
    ...
    std::cout << "WATERMARK: THIS BOT PROVIDE BY @PYSCHOxKINGYT \nTHIS BINARY BY @PYSCHOxKINGYT" << std::endl;
